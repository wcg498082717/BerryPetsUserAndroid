package berry.wcg.com.berrypetsuserandroid.framework.utils.downloadutils;
...
public class AppInnerDownLoder {
	...
	private static String tag = "AppInnerDownLoder";
	/**
	 * 从服务器中下载APK
	 */
...
//		mContext.startActivity(it);
		...
		if(Build.VERSION.SDK_INT>=24) {//判读版本是否在7.0以上
			Uri apkUri = FileProvider.getUriForFile(mContext, "wcg.zhuli.yingwuj.fileprovider", file);
