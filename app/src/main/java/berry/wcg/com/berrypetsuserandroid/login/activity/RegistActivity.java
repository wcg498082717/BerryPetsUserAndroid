...
public class RegistActivity extends BaseActivity {
    ...
    private RegisterPersenter persenter;
    int time = 60;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        persenter=new RegisterPersenter(RegistActivity.this);
    }
                    ...
                    if (etPassword.getText().toString().equals(etPassword2.getText().toString())) {
                        if(etPassword.getText().toString().length()>=6){
                            if(persenter.checkVeifyCode(etVerfycode.getText().toString())){
                                persenter.regist(etPhone.getText().toString(),etPassword.getText().toString(),etVerfycode.getText().toString());
                            }else{
                                T.showShort( "验证码错误");
                            }
                        }else{
